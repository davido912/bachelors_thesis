...
%TODO: DB INTRODUCED IN DATA COLLECTION BEFORE INDICATED TO BE CASE PARTICIPANT
...
%TODO: write about deragluations for db and X
\vspace{-2mm}
...
%TODO: this repeats data analysis chapter, diversify itt
...
%The use of literature, in conjunction with the application of a multiple case study using two firms operating in the finance sector, 

%. In particular, this study's goal was to observe differences and similarities between EBCs and traditional companies. The motivation behind 
% write in the conclusion how this study contributes and can be used as basis or enhancement
