...
\label{discussion}
\frenchspacing
\noindent{This chapter looks into the propositions made in chapter \ref{findings_comparison}, while highlighting possible connections between previous studies and academic work covered in the literature review of this dissertation.} \par %maybe add more 
...
\label{conclusion}
\vspace{-1mm}
\noindent{This dissertation's objective was to examine the internationalisation process of EBCs and traditional companies in the finance sector, and in particular, to derive differences and similarities assisting in drawing new conclusions or revelations, about the possible phenomena of using internet technology as means of doing business. Specifically, the following research question was investigated: \textit{"How do E-Business Companies internationalise in comparison to traditional companies in the financial sector?"}.}  \par
